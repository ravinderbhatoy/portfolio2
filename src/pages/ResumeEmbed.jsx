...
function ResumeEmbed() {
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-12 h-screen">
      <Navbar />
      <PageHeading
        title="Resume"
        subtitle="A focused view of my education, technical skills, and professional profile."
      />
      <div className="bg-light-violet w-full h-5 opacity-70 mb-7"></div>
      <div className="relative h-full lg:overflow-scroll no-scrollbar lg:h-[calc(100vh-18rem)] ">
          {isLoading && 
